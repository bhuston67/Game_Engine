KeyboardControls = {
	...
	OnUpdate = function(self)
		...
		if Input.GetLeftJoystickDirection("right") then
			horizontal_input = self.speed
		end

		if Input.GetLeftJoystickDirection("left") then
			horizontal_input = -self.speed
		end
		...
		if Input.GetControllerButtonDown("A") or Input.GetKeyDown("space") then
